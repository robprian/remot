...
import com.remot.app.ServiceLocator
import com.remot.app.unattended.Scope
import com.remot.app.util.parcelable
...
class UnattendedHostService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        wakeLock = getSystemService(PowerManager::class.java)
            .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "remot:unattended")
