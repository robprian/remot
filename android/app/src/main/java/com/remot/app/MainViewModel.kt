...
import com.remot.app.host.RemoteInputService
import com.remot.app.session.SessionCodes
import com.remot.app.trust.PeerIdentity
...
class MainViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun approveIncoming(resultCode: Int, data: android.content.Intent) {
        ...
        com.remot.app.host.ScreenCaptureService.start(
