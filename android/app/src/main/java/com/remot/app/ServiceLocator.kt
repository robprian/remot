...
import com.remot.app.session.SessionManager
import com.remot.app.signaling.SignalingClient
import com.remot.app.trust.PairingManager
import com.remot.app.trust.TrustStore
import com.remot.app.unattended.GrantStore
import com.remot.app.webrtc.WebRtcCore
...
object ServiceLocator : SignalingClient.Listener {
    ...
    override fun onAuthChallenge(from: String, nonceB64: String) {
        ...
        val sig = DeviceIdentity.sign(com.remot.app.crypto.Crypto.unb64(nonceB64))
        signaling.sendAuthResponse(from, com.remot.app.crypto.Crypto.b64(sig))
    }
